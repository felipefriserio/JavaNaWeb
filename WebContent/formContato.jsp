...
<body>
    ...
    <div class="container" style="margin-top: 75px;">
	    <form class="form-horizontal" action="cadContato.jsp" method="post">
			<fieldset>
				<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="nome">Nome</label>  
				  <div class="col-md-5">
				 	 <input name="nome" type="text" placeholder="Nome completo" class="form-control input-md" required="">
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				  	<input name="idade" type="text" placeholder="Idade" class="form-control input-md" required="">
				  </div>
				</div>
